...
DEFAULT_CONFIG_FILENAME = "wlk_passwordsafe_config.json"  # Name der Standard-Konfigurationsdatei
...
try:
    ...
    _WLK_APP_CLS = None
    for _name in ("wlk_passwordsafeApp", "App", "PasswordManagerApp"):
        try:
...
DEFAULT_CONFIG_FILENAME = globals().get("DEFAULT_CONFIG_FILENAME", "wlk_passwordsafe_config.json")
