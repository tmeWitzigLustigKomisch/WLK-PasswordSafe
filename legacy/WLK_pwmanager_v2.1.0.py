...
Diese Werkzeuge erzeugen ein zufälliges Cover-Bild (BMP/PNG/JPEG) bzw. blasen ein vorhandenes Bild
...
def launch_gui(path: Path) -> None:
    ...
    class App:
        ...
        def build_login_ui(self):
            ...
            ttk.Button(btns, text="Beenden", command=self.root.destroy).pack(side="left", padx=6)
        ...
        def gui_view(self):
            ...
            ttk.Label(frm, text=e.website).grid(row=3, column=1, sticky="w", pady=2, padx=(4,0))

            # Passwortzeile mit Auto-Hide

            ttk.Label(frm, text="Passwort:").grid(row=4, column=0, sticky="w", pady=2)
