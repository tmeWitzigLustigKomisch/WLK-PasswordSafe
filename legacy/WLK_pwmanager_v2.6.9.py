...
def _pre_kdf(master_pw: bytes) -> bytes:
    ...
    try:
        ...
        try:
            ...
            # _load_keyfile_bytes gibt leere Bytes zurück bei Fehlern; wir
            # propagieren nur FileNotFoundError weiter, alle anderen Fehler
            # resultieren in der Verwendung eines leeren Peppers
