...
def launch_gui(path: Path) -> None:
    ...
    class App:
        ...
        def build_login_ui(self):
            ...
            # Zusätzlich: Wenn der Farbschema-Umschalter deaktiviert ist, füge einen Versuchs-Hinweis ein.
            if not SHOW_LIGHT_DARK_TOGGLE:
                # Leere Zeile zur Abgrenzung
                ttk.Label(frm, text="").pack(anchor="w")
                # Hinweis zum Testmodus
                ttk.Label(frm, text=tr("Versuchsweise:", "Experimental:")).pack(anchor="w", padx=6)
                # Ausführliche Meldung mit Hinweis zur Testvariable
                ttk.Label(
                    frm,
                    text=tr(
        ...
        def build_main_ui(self):
            ...
            # Hinweis: Falls das Farbschema-Umschalten deaktiviert ist, informiere den Benutzer über die Konfigurationsmöglichkeit
            if not SHOW_LIGHT_DARK_TOGGLE:
                # Leerzeile zur optischen Trennung
                ttk.Label(status_frame, text="").pack(side="top", anchor="w")
                # Hinweis, dass die Funktion nur versuchsweise aktivierbar ist
                ttk.Label(status_frame, text=tr("Versuchsweise:", "Experimental:")).pack(side="top", anchor="w")
                # Ausführliche Meldung mit Hinweis zur Testvariable
                ttk.Label(
                    status_frame,
                    text=tr(
