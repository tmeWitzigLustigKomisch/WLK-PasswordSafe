...
def launch_gui(path: Path) -> None:
    ...
    class App:
        ...
        def toggle_dark_mode(self) -> None:
            ...
            global GUI_BG_COLOR, GUI_FG_COLOR, GUI_BUTTON_COLOR
            try:
            ...
            try:
                ...
                if GUI_BG_COLOR:
                    ...
                    # Wenn kein Hintergrund definiert ist, setze auf Standard (leer)
                ...
                try:
                    ...
                    pass
                # Hintergrundfarben für Frame und Label
                if GUI_BG_COLOR:
                    style.configure('TFrame', background=GUI_BG_COLOR)
                    style.configure('TLabel', background=GUI_BG_COLOR)
                else:
                    # Leere Farben entfernen, um das Standard‑Theme zu nutzen
                ...
                # Eingabefelder hell lassen für guten Kontrast
                try:
                    style.configure('TEntry', fieldbackground='#f5f5f5', background='#f5f5f5')
                    style.configure('TCombobox', fieldbackground='#f5f5f5', background='#f5f5f5')
                except Exception:
